...
public abstract class BlockHeavenlyLeaves extends BlockHeavenlyLeavesBase implements net.minecraftforge.common.IShearable
{
    ...
    public BlockHeavenlyLeaves(String name)
    {
        super(name, Material.leaves, false);
