...
public abstract class BlockHeavenlyLogBase extends BlockRotatedPillarHeavenlyBase
{
    public static final PropertyEnum LOG_AXIS = PropertyEnum.create("axis", BlockHeavenlyLogBase.EnumAxis.class);

    public BlockHeavenlyLogBase(String Name)
    {
    ...
    {
        return super.onBlockPlaced(worldIn, pos, facing, hitX, hitY, hitZ, meta, placer).withProperty(LOG_AXIS, BlockHeavenlyLogBase.EnumAxis.fromFacingAxis(facing.getAxis()));
    }
    ...
    public static enum EnumAxis implements IStringSerializable
    {
        ...
        public static BlockHeavenlyLogBase.EnumAxis fromFacingAxis(EnumFacing.Axis axis)
        {
            switch (BlockHeavenlyLogBase.SwitchAxis.AXIS_LOOKUP[axis.ordinal()])
            {
                case 1:
                    return X;
                case 2:
