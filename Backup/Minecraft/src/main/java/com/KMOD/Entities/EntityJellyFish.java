...
import animations.JellyFish.AnimationHandlerJellyFish;

import com.KMOD.Core.KCore;

public class EntityJellyFish extends EntityFlying implements IMob, IMCAnimatedEntity
{
    private final EntityAIControlledByPlayer aiControlledByPlayer;
    public boolean isMounted = false;
	protected AnimationHandler animHandler = new AnimationHandlerJellyFish(this);
    ...
    public EntityJellyFish(World worldIn)
    {
        ...
        this.moveHelper = new EntityJellyFish.GhastMoveHelper();
        this.tasks.addTask(5, new EntityJellyFish.AIRandomFly());
        this.tasks.addTask(7, new EntityJellyFish.AILookAround());
        this.tasks.addTask(7, new EntityJellyFish.AIFireballAttack());
    ...
    {
    	if(!this.animHandler.isAnimationActive("fly"))
    	{
    		this.animHandler.activateAnimation("Fly", 0);
    	}
    ...
    {
        private EntityJellyFish field_179470_b = EntityJellyFish.this;
    ...
    {
        private EntityJellyFish field_179472_a = EntityJellyFish.this;
    ...
    {
        private EntityJellyFish field_179454_a = EntityJellyFish.this;
