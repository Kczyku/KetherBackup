...
public class EntitySpectator extends EntityFlying implements IMob
{

    public EntitySpectator(World worldIn)
    {
        super(worldIn);
        this.setSize(4.0F, 4.0F);
        this.isImmuneToFire = true;
        this.experienceValue = 75;
        this.moveHelper = new EntitySpectator.GhastMoveHelper();
        this.tasks.addTask(5, new EntitySpectator.AIRandomFly());
        this.tasks.addTask(7, new EntitySpectator.AILookAround());
        this.tasks.addTask(7, new EntitySpectator.AIFireballAttack());
    ...
    {
    	//TODO
        return Item.getItemFromBlock(KCore.ProcessedBasalt);
    }
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        ...
        for (k = 0; k < j; ++k)
        {
            this.dropItem(Item.getItemFromBlock(KCore.ProcessedBasalt), 1);
        }
    ...
    {
        return this.rand.nextInt(5) == 0 && super.getCanSpawnHere() && this.worldObj.getDifficulty() != EnumDifficulty.PEACEFUL;
    }
    ...
    {
        private EntitySpectator field_179470_b = EntitySpectator.this;
        ...
        public void updateTask()
        {
            ...
            if (entitylivingbase.getDistanceSqToEntity(this.field_179470_b) < d0 * d0 && this.field_179470_b.canEntityBeSeen(entitylivingbase))
            {
                ...
                if (this.field_179471_a == 20)
                {
                    ...
                    EntityMagicShoot entitylargefireball = new EntityMagicShoot(world, entitylivingbase, d2, d3, d4);
    ...
    {
        private EntitySpectator field_179472_a = EntitySpectator.this;
    ...
    {
        private EntitySpectator field_179454_a = EntitySpectator.this;
