...
public class EntityBoar extends EntityAnimal
{
    ...
    public EntityBoar(World p_i1689_1_)
    {
        ...
        this.tasks.addTask(3, new EntityAITempt(this, 1.2D, Items.apple, false));
    ...
    {
        return this.isBurning() ? KCore.Venison : KCore.Venison;
    }
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        ...
        for (int k = 0; k < j; ++k)
        {
            if (this.isBurning())
            {
                this.dropItem(KCore.Venison, 2);
            }
            else
            {
                this.dropItem(KCore.Venison, 1);
            }
        }
    ...
    public boolean isBreedingItem(ItemStack p_70877_1_)
    {
    	if(p_70877_1_ != null)
    	{
    		if(p_70877_1_.getItem() == Items.apple)
    		{
    			return true;
    		}
    		else
