...
public class EntityBird extends EntityAmbientCreature
{
    ...
    protected void updateAITasks()
    {
        ...
        else
        {
            ...
            if (this.rand.nextInt(100) == 4 && this.worldObj.getBlockState(blockpos1).getBlock().isNormalCube())
            {
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund)
    {
        ...
        this.isColorSetted = tagCompund.getBoolean("isColorSetted");
        this.Color = tagCompund.getString("Color");
    }
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound)
    {
        ...
        tagCompound.setBoolean("isColorSetted", this.isColorSetted);
        tagCompound.setString("Color", this.Color);
    }
