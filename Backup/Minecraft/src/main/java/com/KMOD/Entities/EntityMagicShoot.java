...
public class EntityMagicShoot extends Entity
{
    ...
    public EntityMagicShoot(World worldIn)
    {
        super(worldIn);
    ...
    public EntityMagicShoot(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ)
    {
        super(worldIn);
        this.setSize(1.0F, 1.0F);
    ...
    public EntityMagicShoot(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ)
    {
        super(worldIn);
    ...
    protected void onImpact(MovingObjectPosition movingObject)
    {
        if (!this.worldObj.isRemote)
        {
            ...
            {
                movingObject.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this.shootingEntity, movingObject.entityHit), 6F);
                this.func_174815_a(this.shootingEntity, movingObject.entityHit);
                movingObject.entityHit.motionY = 0.3D;
            }
