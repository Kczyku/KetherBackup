...
public class HeavenChunkManager extends WorldChunkManager
{
    public static List<BiomeGenBase> allowedBiomes = Lists.newArrayList(KCore.Heaven, KCore.HeavenForest, KCore.HeavenDesert, KCore.HeavenMountains
    		, KCore.HeavenPlains);
    ...
    public HeavenChunkManager(long p_i45744_1_, WorldType p_i45744_3_, String p_i45744_4_)
    {
        this();
        this.field_180301_f = p_i45744_4_;
        GenLayer[] agenlayer = GenLayerHeaven.initializeAllBiomeGenerators(p_i45744_1_, p_i45744_3_, p_i45744_4_);
        agenlayer = getModdedBiomeGenerators(p_i45744_3_, p_i45744_1_, agenlayer);
        this.genBiomes = agenlayer[0];
        this.biomeIndexLayer = agenlayer[1];
    }

    public HeavenChunkManager(World worldIn)
    {
