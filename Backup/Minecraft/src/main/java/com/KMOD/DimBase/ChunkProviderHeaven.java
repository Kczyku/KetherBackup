...
public class ChunkProviderHeaven implements IChunkProvider
{
    ...
    public ChunkProviderHeaven(World worldIn, long p_i45636_2_, boolean p_i45636_4_, String p_i45636_5_)
    {
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int j3 = 0; j3 < 4; ++j3)
                            {
                                if ((d15 += d16) > 0.0D)
                                {
                                    p_180518_3_.setBlockState(k * 4 + i3, k2 * 8 + l2, j1 * 4 + j3, KCore.HeavenlyStone.getDefaultState());
                                }
                            }
    ...
    public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
    {
        ...
        if (this.settings.useWaterLakes && !flag && this.rand.nextInt(this.settings.waterLakeChance) == 0 && TerrainGen.populate(p_73153_1_, worldObj, rand, p_73153_2_, p_73153_3_, flag, LAKE))
        {
