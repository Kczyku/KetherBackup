...
public class ContainerRunesPutter extends Container
{
    ...
    public ContainerRunesPutter(InventoryPlayer p_i45794_1_, IInventory furnaceInventory)
    {
        this.tileFurnace = furnaceInventory;
        this.addSlotToContainer(new Slot(furnaceInventory, 0, 25, 14));
        this.addSlotToContainer(new SlotFurnaceOutput(p_i45794_1_.player, furnaceInventory, 1, 105, 29));
        this.addSlotToContainer(new Slot(furnaceInventory, 2, 25, 45));
