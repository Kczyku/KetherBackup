...
public class ContainerEnchanter extends Container
{
    ...
    public ContainerEnchanter(InventoryPlayer p_i45794_1_, IInventory furnaceInventory)
    {
        this.tileFurnace = furnaceInventory;
        this.addSlotToContainer(new Slot(furnaceInventory, 0, 4, 15));
        this.addSlotToContainer(new SlotFurnaceFuel(furnaceInventory, 1, 56, 52));
        this.addSlotToContainer(new SlotFurnaceOutput(p_i45794_1_.player, furnaceInventory, 2, 113, 26));
        this.addSlotToContainer(new Slot(furnaceInventory, 3, 4, 35));
