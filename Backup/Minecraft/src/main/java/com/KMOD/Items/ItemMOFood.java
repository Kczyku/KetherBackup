...
public class ItemMOFood extends ItemFood
{
    ...
    public ItemMOFood(String Name, int amount, float saturation, boolean isWolfFood)
    {
    ...
    public ItemMOFood(String Name, int amount, boolean isWolfFood)
    {
     ...
     */
    public ItemMOFood setPotionEffect(int id, int duration, int amplifier, float probability)
    {
        this.potionId = id;
     ...
     */
    public ItemMOFood setAlwaysEdible()
    {
