...
public class ItemMOTool extends ItemTool
{
    ...
    protected ItemMOTool(String Name, float attackDamage, ToolMaterial material, Set effectiveBlocks)
    {
        ...
        if (this instanceof ItemMOPickaxe)
        {
            toolClass = "pickaxe";
        }
        else if (this instanceof ItemMOAxe)
        {
            toolClass = "axe";
        }
        else if (this instanceof ItemMOShovel)
        {
            toolClass = "shovel";
        }
    }
