...
public class RenderFloatingBlock extends Render
{
    ...
    public RenderFloatingBlock(RenderManager p_i46177_1_)
    {
        super(p_i46177_1_);
        this.shadowSize = 0.5F;
    }

    public void doRender(EntityFloatingBlock p_180557_1_, double p_180557_2_, double p_180557_4_, double p_180557_6_, float p_180557_8_, float p_180557_9_)
    {
    ...
    {
        return this.getEntityTexture((EntityFloatingBlock)entity);
    }
    ...
    {
        this.doRender((EntityFloatingBlock)entity, x, y, z, p_76986_8_, partialTicks);
    }
}