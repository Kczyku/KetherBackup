...
public class GenHeavenlyMegaPineTree extends GenHugeTreesBase
{
    private boolean field_150542_e;

    public GenHeavenlyMegaPineTree(boolean p_i45457_1_, boolean p_i45457_2_)
    {
        super(p_i45457_1_, 13, 15);
        this.field_150542_e = p_i45457_2_;
    }

    public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_)
    {
    	if(worldIn.getBlockState(p_180709_3_.down()) == KCore.HeavenlyGrass.getDefaultState())
    	{
        ...
        else
        {
            ...
            for (int j = 0; j < i; ++j)
            {
                ...
                {
                    worldIn.setBlockState(p_180709_3_.up(j), KCore.HeavenlyLog.getDefaultState());
                }
                ...
                if (j < i - 1)
                {
                    ...
                    {
                    	worldIn.setBlockState(p_180709_3_.add(1, j, 0), KCore.HeavenlyLog.getDefaultState());
                    }

                    if (this.isAirLeaves(worldIn, p_180709_3_.add(1, j, 1)))
                    {
                    	worldIn.setBlockState(p_180709_3_.add(1, j, 1), KCore.HeavenlyLog.getDefaultState());
                    }

                    if (this.isAirLeaves(worldIn, p_180709_3_.add(0, j, 1)))
                    {
                    	worldIn.setBlockState(p_180709_3_.add(0, j, 1), KCore.HeavenlyLog.getDefaultState());
                    }
                }
            }
