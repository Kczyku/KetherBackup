...
public class GenAccaciaHeavenlyTree extends GenAbstractHeavenlyTree
{

    public GenAccaciaHeavenlyTree(boolean p_i45463_1_)
    {
        super(p_i45463_1_);
    }
            ...
            else
            {
                ...
                if (isSoil && p_180709_3_.getY() < 256 - i - 1)
                {
                    ...
                    for (int l1 = 0; l1 < i; ++l1)
                    {
                        ...
                        {
                            this.func_175905_a(worldIn, blockpos1, KCore.HeavenlyLog, BlockPlanks.EnumType.ACACIA.getMetadata() - 4);
                            k1 = i2;
                        }
                    }
                    ...
                    if (enumfacing1 != enumfacing)
                    {
                        ...
                        for (int l2 = i2; l2 < i && k2 > 0; --k2)
                        {
                            if (l2 >= 1)
                            {
                                ...
                                {
                                    this.func_175905_a(worldIn, blockpos2, KCore.HeavenlyLog, BlockPlanks.EnumType.ACACIA.getMetadata() - 4);
                                    k1 = j2;
                                }
                            }
    ...
    private void func_175924_b(World worldIn, BlockPos p_175924_2_)
    {
        ...
        {
            this.func_175905_a(worldIn, p_175924_2_, KCore.HeavenlyLeaves, 0);
        }
    }
}