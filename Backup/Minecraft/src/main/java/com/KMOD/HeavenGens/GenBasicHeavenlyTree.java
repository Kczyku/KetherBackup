...
public class GenBasicHeavenlyTree extends GenAbstractHeavenlyTree
{
    private final int minTreeHeight;
    private final boolean vinesGrow;

    public GenBasicHeavenlyTree(boolean p_i2027_1_)
    {
        this(p_i2027_1_, 4, false);
    }

    public GenBasicHeavenlyTree(boolean p_i2028_1_, int p_i2028_2_, boolean p_i2028_5_)
    {
        super(p_i2028_1_);
                        ...
                        for (k1 = p_180709_3_.getX() - j1; k1 <= p_180709_3_.getX() + j1; ++k1)
                        {
                            ...
                            for (int i2 = p_180709_3_.getZ() - j1; i2 <= p_180709_3_.getZ() + j1; ++i2)
                            {
                                ...
                                if (Math.abs(l1) != j1 || Math.abs(j2) != j1 || p_180709_2_.nextInt(2) != 0 && i1 != 0)
                                {
                                    ...
                                    {
                                        this.func_175906_a(worldIn, blockpos1, KCore.HeavenlyLeaves);
                                    }
                                }
                            }
                        }
