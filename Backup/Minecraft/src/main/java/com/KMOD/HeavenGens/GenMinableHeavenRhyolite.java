...
public class GenMinableHeavenRhyolite extends WorldGenerator
{
    private final IBlockState oreBlock;
    private final int numberOfBlocks;
    private final Predicate field_175919_c;

    public GenMinableHeavenRhyolite(IBlockState p_i45630_1_, int p_i45630_2_)
    {
        this(p_i45630_1_, p_i45630_2_, BlockHelper.forBlock(KCore.Rhyolite));
    }

    public GenMinableHeavenRhyolite(IBlockState p_i45631_1_, int p_i45631_2_, Predicate p_i45631_3_)
    {
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D)
                        {
                            for (int j2 = l; j2 <= k1; ++j2)
                            {
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D)
                                {
                                    ...
                                    {
                                        worldIn.setBlockState(blockpos1, this.oreBlock);
                                    }
                                }
                            }
                        }
