...
public abstract class GenHugeTreesBase extends GenAbstractHeavenlyTree
{
    ...
    public GenHugeTreesBase(boolean p_i45458_1_, int p_i45458_2_, int p_i45458_3_)
    {
        super(p_i45458_1_);
        ...
        for (int k = -p_175925_3_; k <= p_175925_3_ + 1; ++k)
        {
            for (int l = -p_175925_3_; l <= p_175925_3_ + 1; ++l)
            {
                ...
                if (k * k + l * l <= j || i1 * i1 + j1 * j1 <= j || k * k + j1 * j1 <= j || i1 * i1 + l * l <= j)
                {
                    ...
                    {
                        worldIn.setBlockState(blockpos1, KCore.HeavenlyGoldenLeaves.getDefaultState());
                    }
                }
            }
        }
