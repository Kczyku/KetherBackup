...
public class GenMinableHeaven extends WorldGenerator
{
    private final IBlockState oreBlock;
    private final int numberOfBlocks;
    private final Predicate field_175919_c;

    public GenMinableHeaven(IBlockState p_i45630_1_, int p_i45630_2_)
    {
        this(p_i45630_1_, p_i45630_2_, BlockHelper.forBlock(KCore.HeavenlyStone));
    }

    public GenMinableHeaven(IBlockState p_i45631_1_, int p_i45631_2_, Predicate p_i45631_3_)
    {
